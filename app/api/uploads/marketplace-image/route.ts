...
export async function POST(req: Request) {
  try {
    ...
    // Use admin client for storage to avoid owner_id UUID constraint with external JWT
    ...
    const { data } = await admin.storage.from('marketplace-images').getPublicUrl(fileName);
