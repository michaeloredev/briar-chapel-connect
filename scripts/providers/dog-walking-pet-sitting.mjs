// Providers for pet-services/dog-walking-pet-sitting.
// Seeded by scripts/seed-providers.mjs; extracted verbatim from seed-dog-walking-pet-sitting-providers.mjs.

export const CATEGORY = 'pet-services/dog-walking-pet-sitting';
