// Providers for food-hospitality/local-restaurants-cafes.
// Seeded by scripts/seed-providers.mjs; extracted verbatim from seed-local-restaurants-cafes-providers.mjs.

export const CATEGORY = 'food-hospitality/local-restaurants-cafes';
