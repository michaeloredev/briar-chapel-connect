// Providers for pet-services/local-veterinarians.
// Seeded by scripts/seed-providers.mjs; extracted verbatim from seed-local-veterinarians-providers.mjs.

export const CATEGORY = 'pet-services/local-veterinarians';
