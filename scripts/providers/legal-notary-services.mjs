// Providers for professional-miscellaneous/legal-notary-services.
// Seeded by scripts/seed-providers.mjs; extracted verbatim from seed-legal-notary-services-providers.mjs.

export const CATEGORY = 'professional-miscellaneous/legal-notary-services';
