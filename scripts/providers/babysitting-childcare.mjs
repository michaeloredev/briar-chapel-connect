// Providers for community-personal-services/babysitting-childcare.
// Seeded by scripts/seed-providers.mjs; extracted verbatim from seed-babysitting-childcare-providers.mjs.

export const CATEGORY = 'community-personal-services/babysitting-childcare';
